...
class NewUserForm(UserCreationForm):
    ...
    username =forms.CharField(required=True,widget=forms.TextInput(attrs={'class':'input input-bordered input-primary w-full max-w-xs','placeholder':'Enter your name'}))
